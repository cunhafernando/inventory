class ComputersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @computer.save
        format.html { redirect_to computer_url(@computer), notice: "Computer was successfully created." }
  ...
  private
    ...
    def computer_params
      params.require(:computer).permit(:gati, :brand, :model, :serial_number, :patrimony)
    end
end
