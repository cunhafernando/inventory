class AllocationsController < ApplicationController
  ...
  def create
    ...
    @allocation.user_id = current_user.id if current_user

    respond_to do |format|
      if @allocation.save
        format.html { redirect_to allocation_url(@allocation), notice: "Alocação criada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @allocation.update(allocation_params)
        format.html { redirect_to allocation_url(@allocation), notice: "Alocação atualizada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to allocations_url, notice: "Alocação removida com sucesso." }
  ...
  private
    ...
    def allocation_params
      params.require(:allocation).permit(:unit, :office, :user_id)
    end
end
