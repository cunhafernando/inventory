class EquipmentController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @equipment.update(equipment_params)
        format.html { redirect_to equipment_url(@equipment), notice: "Equipmento atualizado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to equipment_index_url, notice: "Equipmento apagado com sucesso." }
  ...
  private
    ...
    def equipment_params
      params.require(:equipment).permit(:kind_of_equipment, :gati, :brand, :model, :serial_number, :patrimony, :allocate, :maintenance, :supplier_id, :user_id, :macadress)
    end
end
