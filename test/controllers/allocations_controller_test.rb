...
class AllocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create allocation" do
    assert_difference("Allocation.count") do
      post allocations_url, params: { allocation: { office: @allocation.office, unit: @allocation.unit } }
    end
  ...
  test "should update allocation" do
    patch allocation_url(@allocation), params: { allocation: { office: @allocation.office, unit: @allocation.unit } }
