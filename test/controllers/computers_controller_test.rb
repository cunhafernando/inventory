...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference("Computer.count") do
      post computers_url, params: { computer: { brand: @computer.brand, gati: @computer.gati, model: @computer.model, patrimony: @computer.patrimony, serial_number: @computer.serial_number } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { brand: @computer.brand, gati: @computer.gati, model: @computer.model, patrimony: @computer.patrimony, serial_number: @computer.serial_number } }
